...
const validateRegister = [
  ...
  body('role').isIn(['Admin', 'HR Manager', 'Manager', 'Employee']).withMessage('Valid role is required')
];
...
// PATCH /api/auth/users/:id/activate - Activate/Deactivate user (Admin only)
